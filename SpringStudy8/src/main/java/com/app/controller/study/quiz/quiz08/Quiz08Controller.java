...
public class Quiz08Controller {
	...
	@GetMapping("/member")
	public String member(@RequestParam(name = "auth", required = false) String auth, Model model) {

		// http://localhost:8080/quiz08/member?auth=admin
...
//		if(auth.equals("admin")) { //모든 사용자 목록을 표시
//			
//			resultList = memberList;
//			
//		} else if (auth.equals("basic") || auth.equals("manager")) {
