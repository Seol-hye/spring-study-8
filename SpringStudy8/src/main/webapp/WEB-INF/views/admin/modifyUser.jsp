...
<body>
	...
	<form action="/admin/modifyUser" method="post">
		...
		사용자 아이디: <input type="text" name="name" value="${user.name}" disabled>
		...
		<label>관리자 <input type="radio" name="userType" value='ADM'
		<c:if test="${user.userType == 'ADM'}">checked</c:if>></label>
